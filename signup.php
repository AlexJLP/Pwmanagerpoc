...
action="do-signup.php" method="post">';
      print '  <fieldset>';
      print '    <legend>Sign up(Create new account)</legend>';
      ...
      print '      <div class="controls">';
      print '        <input id="password" name="password" type="password" placeholder="password" class="input-medium" required="" onchange="salt_and_hash()">';
      print '      </div>';
      print '    </div>';
      print '    <div class="control-group">';
